...
```{r}
################################################################################
# Figure 4.16-4.21 The absolute LIME values in LSTM model for the Canadian 9 CDs datasets
################################################################################
...
#### Focus to Toronto
################################################################################
# Figure 4.16 The LIME values in LSTM model with m=5 for the Toronto datasets
################################################################################
...
################################################################################
# Figure 4.17 The absolute LIME values in LSTM model with m=5 for the Toronto datasets
################################################################################
CanDF9CDseq5 %>% mutate(city=factor(city)) %>%  filter(city =="3520" ) %>%  ggplot()+
...
################################################################################
# Figure 4.18 The absolute LIME values in LSTM model with m=2 for the Canadian CD datasets
################################################################################
...
################################################################################
# Figure 4.19 The absolute LIME values in LSTM model with m=3 for the Canadian CD datasets
################################################################################
my_labeller <- as_labeller(c("3506"="Ottawa","3520"="Toronto","3524"="Halton","3525"="Hamilton","3543"="Simcoe")
)
my_labeller2 <- as_labeller(c("O3"="O3","NO2"="NO2","Temp"="Temperature"))
...
################################################################################
# Figure 4.20 The absolute LIME values in LSTM model with m=4 for the Canadian CD datasets
################################################################################
my_labeller <- as_labeller(c("3506"="Ottawa","3520"="Toronto","3524"="Halton","3525"="Hamilton","3543"="Simcoe")
)
my_labeller2 <- as_labeller(c("O3"="O3","NO2"="NO2","Temp"="Temperature"))
...
################################################################################
# Figure 4.21 The absolute LIME values in LSTM model with m=5 for the Canadian CD datasets
################################################################################
my_labeller <- as_labeller(c("3506"="Ottawa","3520"="Toronto","3524"="Halton","3525"="Hamilton","3543"="Simcoe")
)
my_labeller2 <- as_labeller(c("O3"="O3","NO2"="NO2","Temp"="Temperature"))
