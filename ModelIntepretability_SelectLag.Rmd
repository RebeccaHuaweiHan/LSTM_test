...
# ggsave(filename = "~/deeplearning/LSTM_Test/LSTM_Test/data_nmmaps/LIME/LIME_yearly_Lag03.png",height=6,width=7,dpi = 500) 
...
DF %>% ggplot() +
  ...
  geom_point(aes(x=Year_floor, y=Year_Lag_avg_LIMEvalue,color=predictor))+
  scale_color_brewer(palette="Set2")+
  xlab("Time")+
