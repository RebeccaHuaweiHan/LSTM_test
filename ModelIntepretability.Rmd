...
```{r}
################################################################################
# Figure 4.2 to 4.6 The LIME values for 4 air pollutions in the LSTM model with the Chicago dataset.
################################################################################
...
ggsave(filename = "~/deeplearning/LSTM_Test/LSTM_Test/data_nmmaps/LIME/LIME_yearly_O3_color.png",
